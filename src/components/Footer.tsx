...
export const Footer: React.FC<FooterProps> = ({ onCtaClick }) => {
  ...
  return (
    <footer id="main-footer" className="bg-[#1A1A1A] text-white pt-12 sm:pt-16 pb-24 md:pb-14 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Main Brand & Navigation Section */}
        <div className="flex flex-col md:flex-row items-start justify-between gap-8 sm:gap-10 pb-8 sm:pb-12 border-b border-white/10">
          ...
          <div className="space-y-3">
            ...
            <p className="font-montserrat text-xs sm:text-sm text-white/70 leading-relaxed max-w-md font-normal">
          ...
          <div className="flex flex-col md:items-end">
            <p className="font-montserrat text-[11px] font-bold uppercase tracking-[0.2em] text-[#AB8850] mb-3.5">
              PLATFORM
            </p>
            <ul className="flex flex-wrap gap-5 sm:gap-7 font-montserrat text-xs sm:text-sm text-white/70 mb-5 sm:mb-6">
              <li>
            ...
            <div className="hidden sm:inline-flex flex-col sm:flex-row items-center gap-2.5 sm:gap-3 px-4 sm:px-5 py-2.5 rounded-full bg-white/5 border border-white/15">
              ...
              <button
                ...
                className="px-4 py-1.5 rounded-full bg-[#AB8850] hover:bg-[#C07A61] text-white font-montserrat font-bold text-[10px] sm:text-[11px] tracking-[0.16em] uppercase transition-colors cursor-pointer shrink-0"
              >
                GET ACCESS
              </button>
            </div>
        ...
        <div className="pt-6 sm:pt-8 flex items-center justify-start text-left text-xs font-montserrat text-white/50">

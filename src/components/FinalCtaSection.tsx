...
export const FinalCtaSection: React.FC<FinalCtaSectionProps> = ({ onCtaClick }) => {
  ...
  return (
    <>
      ...
      <section className="py-10 sm:py-14 bg-[#1A1A1A]/5 border-b border-[#1A1A1A]/10">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-[#1A1A1A]/10 mb-3 shadow-xs">
          ...
          <p className="mt-2.5 sm:mt-3 font-montserrat text-xs sm:text-sm text-[#1A1A1A]/75 max-w-xl mx-auto leading-relaxed font-normal">
          ...
          <div className="mt-5">
            <button
              ...
              onClick={onCtaClick}
              className="px-7 py-3 rounded-full bg-[#1A1A1A] hover:bg-[#AB8850] text-white font-montserrat font-bold text-xs tracking-[0.18em] uppercase transition-all duration-300 shadow-xs inline-flex items-center justify-center gap-2 cursor-pointer active:scale-98"
            >
      ...
      <section className="py-14 sm:py-20 lg:py-24 bg-[#FFFFFF] border-b border-[#1A1A1A]/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2.5 sm:gap-3.5 max-w-3xl mx-auto mb-8 sm:mb-10">
            {/* Pill 1 */}

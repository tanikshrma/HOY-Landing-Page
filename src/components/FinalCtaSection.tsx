    ...
    <>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-[#1A1A1A]/5 border-b border-[#1A1A1A]/10">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="mt-3.5 sm:mt-4 font-montserrat text-xs sm:text-sm text-[#1A1A1A]/75 max-w-xl mx-auto leading-relaxed font-normal">
      ...
      {/* 8. FINAL CTA SECTION */}
      <section className="py-20 sm:py-24 lg:py-28 bg-[#FFFFFF] border-b border-[#1A1A1A]/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          
          {/* Top highlight pills with premium distinct icons */}
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-3.5 max-w-3xl mx-auto mb-10 sm:mb-12">
            {/* Pill 1 */}
            <div className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-white border border-[#1A1A1A]/12 shadow-[0_2px_10px_rgba(26,26,26,0.04)] hover:border-[#AB8850]/60 transition-all duration-300">

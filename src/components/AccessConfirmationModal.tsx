        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
          ...
          >
            ...
            <button
              ...
              className="absolute top-5 right-5 p-2 rounded-full text-[#1A1A1A]/50 hover:text-[#1A1A1A] hover:bg-[#1A1A1A]/5 transition-colors cursor-pointer"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <button
              onClick={onClose}
              className="w-full py-3.5 px-6 rounded-full bg-[#1A1A1A] hover:bg-[#AB8850] text-white font-montserrat font-bold text-xs tracking-[0.16em] uppercase transition-all duration-300 cursor-pointer"
            >
              RETURN TO HOY
            </button>
          </motion.div>
